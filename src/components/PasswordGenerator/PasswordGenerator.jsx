...
export function PasswordGenerator() {
  ...
  const handleGeneratePasswordClick = () => {
    ...
    setIsCopyButtonActive(newPassword !== '');
  };
        ...
        <Form>
          <InputWrapper>
            ...
            <CopyBtn
              ...
              disabled={!isCopyButtonActive}
              className={`CopyBtn ${isCopyButtonActive ? '' : 'inactive'}`} // Встановлення властивості disabled на кнопці
              style={{ color: isCopyButtonActive ? '#A4FFAF' : 'gray' }} // Встановлення кольору фону кнопки
            >
              <svg
                ...
                height="24"
                viewBox="0 0 21 24"
                fill={isCopyButtonActive ? `#A4FFAF` : 'gray'} // Зміна кольору іконки
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
